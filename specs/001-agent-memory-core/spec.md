...
- **FR-5**: Retrieval / Injection / MCP — v6.1 §29 Phase 5 + §16 + §18 + v6.2 §10/§12。contentful dual FTS、fixed RRF、CJK routing、schema-validated safe capsule、envelope/provenance stripping、local stdio MCP 5 tools + user-authority CAS、source-evidence-preservingdedupe。
