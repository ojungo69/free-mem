...
- [ ] T057 Populate the corrected runner bundle with runner-owned initial and every recovery provider-egress observation, including full zero-egress no-op receipts, carrying owning case IDs, fresh bundle invocation/process-generation roots, and explicit canonical-order committed event IDs/count/fingerprint; add invocation-bound ordered network/CA/six raw TLS trust receipts and candidate/artifact/environment/invocation/root-bound 12-window plateau evidence with one identical duplicate count and strict non-overlapping action/sample timestamps; bind them through result fingerprints/aggregates and add attempted/final render, manifest/provider/job/retry/lifecycle/pair-bound-conflict/16+1/p95 evidence in `harness/slice1-runtime.mjs`
