...
- [ ] T002 [P] [US4] Add failing byte/control/canonical-URL ProviderProposal/Choice, protocol/resource/fingerprint/successor/signal cases plus closed plateau/workload-receipt/CA/raw-TLS-receipt/conflict/exact-16+1 mutations to `specs/005-product-reset/contracts/validate-slice1-fixture.test.mjs`, `specs/005-product-reset/contracts/validate-alpha-result.test.mjs`, `specs/005-product-reset/contracts/validate-alpha-result-failure.test.mjs`, `specs/005-product-reset/contracts/validate-alpha-result-input.test.mjs`, and `specs/005-product-reset/contracts/validate-alpha-runner-evidence.test.mjs`
...
- [ ] T055 Add failing pin/candidate/evidence-root/incomplete-lifecycle/fabricated-success/normal-proposal/network-deny, forged local-destination, missing/mutated plateau/workload-receipt/no-op-delta/CA/raw-TLS-receipt/trust-anchor/peer-cert/SNI/timing/zero-byte/checkpoint/item/token/concurrency, same-ID/different-digest, and exact-16+1 suite self-tests in `harness/slice1-runtime.test.mjs`
...
- [ ] T057 Populate the corrected runner bundle with network/CA/four raw TLS trust receipts and 12 raw workload/drain/checkpoint/resource windows, bind them through separate result fingerprints/aggregates, and add attempted/final render, manifest/provider/job/retry/lifecycle/conflict/16+1/p95 evidence in `harness/slice1-runtime.mjs`
