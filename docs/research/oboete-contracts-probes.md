...
| Installed size with dependencies | — | pass | 29,852 `du -k` blocks = 29.152 MB after the bundled packages (preact, secretlint, smol-toml) became devDependencies; the first measurement at 8e7a0fa was 32.695 MB ([evidence](../evidence/m1-resource-envelope.md)) | none; margin 0.85 MB, guarded by the T087 pack-check |
