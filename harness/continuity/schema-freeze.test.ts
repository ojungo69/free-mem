...
const INLINE_CONSTS = {
  ...
  "SourceAwareMemoryReviewCandidateV1.properties.reasonCode": "policy_tuple_mismatch",
...
type _InlineConstsMatchContract = [
  ...
  Assert<SameLiteral<contract.SourceAwareMemoryReviewCandidateV1["reasonCode"], ConstAt<"SourceAwareMemoryReviewCandidateV1.properties.reasonCode">>>,
